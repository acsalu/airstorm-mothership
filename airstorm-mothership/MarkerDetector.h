...
#include "ASMarkerDetectionViewController.h"
...
public:
   ...
   */
  MarkerDetector(CameraCalibration calibration, ASMarkerDetectionViewController *viewController);
...
private:
  ...
  ASMarkerDetectionViewController *_viewController;
